...
| モジュール | 内容 | 状況 |
|---|---|---|
| `confidence.py` | §5.7.2 confidence/grounding 算出（DD-09/DD-10 反映。比較形の空白類の吸収と、複数 span の値の ocr_conf・VL 判定を根拠 span 全体で取る理由は `docs/design/grounding-whitespace.md`） | 実装済み・テスト有 |
